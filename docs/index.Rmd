...
## Introduction 
  ...
  The questions outlined in this report include: 1) Are some races incarcerated at higher levels?, 2) Are some regions more prone to incarceration, and what are the possible reasons?, and 3) How does state county level data look different from state data, and why?
